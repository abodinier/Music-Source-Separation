...
#SBATCH --job-name=L2          # name of the job UQS37
...
CL_SOCKET_IFNAME=eno1 python train_new.py --data_dir /gpfsdswork/dataset/MUSDB18/ --ckpdir weights --cfg_path experiments/exp-14/cfg-l2.yaml
