...
#SBATCH --job-name=b128          # name of the job UQS37
...
CL_SOCKET_IFNAME=eno1 python train_kaituoxu.py --data_dir /gpfsdswork/dataset/MUSDB18/ --ckpdir weights --cfg_path experiments/exp-6/cfg_b_128.yaml
