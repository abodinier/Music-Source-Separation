...
#SBATCH --job-name=s3          # name of the job UQS37
...
CL_SOCKET_IFNAME=eno1 python train_kaituoxu.py --data_dir /gpfsdswork/dataset/MUSDB18/ --ckpdir weights --cfg_path experiments/exp-11/cfg_s3.yaml
